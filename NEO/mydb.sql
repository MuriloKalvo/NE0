...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/08/2025 às 07:30
...
INSERT INTO `admin` (`IDAdmin`, `Nome`, `Email`, `Senha`, `Telefone`, `Endereco`, `Genero`, `Nascimento`) VALUES
(1, 'admin', 'admin', 'admin', 1234, NULL, NULL, '2025-08-27'),
(2, 'admin2', 'admin@admin', 'admin', 323, NULL, NULL, '2025-08-05');
...
(4, 'b', 'b', 'b@b', 'b', '2025-08-12', 0, 'b'),
(5, 'c', 'c', 'c@c', 'c', '2025-08-13', 34, 'c'),
(6, 'abc', 'abc', 'abc@abc', 'abc', '2025-08-06', 231331, 'abc');
...
INSERT INTO `curso` (`IDCurso`, `NomeCurso`, `NumCurso`, `EstadoCurso`, `MateriaCurso`, `CHCurso`, `HorarioCurso`, `VagasCurso`, `PeriodoCurso`, `Modalidade`, `PreReqCurso`, `Professor_IDProfessor`) VALUES
(2, 'calculo 1', 1, 'aberto', 'matematica', 120, '2025-08-13 21:54:04', 10, 'tarde', 'EaD', 'nenhum', 1),
(3, 'Processo de Engenharia de Software', 2, 'aberto', 'programação', 120, '2025-08-08 01:12:14', 10, 'tarde', 'presencial', 'algoritmos', 2);
...
INSERT INTO `professor` (`IDProfessor`, `Nome`, `Senha`, `Telefone`, `Endereco`, `Genero`, `Email`, `Nascimento`) VALUES
(1, 'José', '12345678', 45999227719, NULL, NULL, 'jose@gmail.com', NULL),
(2, 'professor', 'professor', 12345, NULL, NULL, 'professor', NULL);
...
INSERT INTO `relatorio` (`IDRelatorio`, `NotaAluno`, `MediaAluno`, `MediaTurma`, `FaltaAluno`, `FaltaTurma`, `Curso_IDCurso`, `Aluno_IDAluno`) VALUES
(1, 6.8, 7, 7, 1, 2, 2, 1),
(4, 9, 0, 0, 2, 0, 3, 1),
(5, 5, 0, 0, 0, 0, 2, 5),
(6, 8, 0, 0, 0, 0, 3, 5),
